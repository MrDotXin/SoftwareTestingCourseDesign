...
public class NotificationService {
     ...
     * 处理消防设备巡检通知
     */
    public void handleUrgentEmergencyNotification(String content, EmergencyTypeEnum emergencyTypeEnum, boolean isPersistent) {
        String title = "紧急情况! " + emergencyTypeEnum.getText();
        WebSocketMessage message = WebSocketMessage.builder()
                .type("URGENT_EMERGENCY")
                .title(title)
                .content(content)
                .urgent(true)  // 逾期巡检为紧急，预警为非紧急
                .build();
