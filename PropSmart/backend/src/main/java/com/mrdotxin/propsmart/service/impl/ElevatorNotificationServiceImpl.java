...
public class ElevatorNotificationServiceImpl implements ElevatorNotificationService {
     ...
     * 通知管理员电梯状态变化
     */
    private void notifyAdminsAboutStatus(Elevator elevator, String status) {
     ...
     * 通知用户关于电梯异常
     */
    private void notifyUsersAboutAbnormality(Elevator elevator, ElevatorAbnormality abnormality, boolean isSerious) {
        // 严重异常通知用户
     ...
     * 创建异常通知内容
     */
    private String createAbnormalityNotificationContent(Elevator elevator, ElevatorAbnormality abnormality, 
